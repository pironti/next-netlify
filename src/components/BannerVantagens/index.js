...
const btnOpcoes = [
  ...
  },
  {
    ...
    descr:
      "Use o saldo excedente da sua carta de crédito para pagar as despesas tributárias do seu novo carro.",
  },
  {
    image: "/images/produto/money2.svg",
    title: "Sem Juros",
    descr:
      "Diferente do financiamento, você não precisa pagar juros ou entrada do seu novo carro.",
  },
  {
    image: "/images/produto/car.svg",
    title: "Seu Usado como Lance",
    descr:
      "Se preferir, pode usar o seu carro usado como lance para um novo carro no consórcio.",
  },
];
  ...
  return (
    <ContainerBase>
      <div className=".nossos-produtos-title mx-auto mt-8 md:pt-8 text-center pr-8 pl-8">
        <p className="font-extrabold text-4xl md:text-4xl ">{titulo}</p>
      </div>
        ...
        {ajudas.map((ajuda, index) => (
          ...
          <div className="bg-white w-full h-full flex flex-col md:rounded-3xl shadow-md">
            ...
            <div className="mx-auto p-4 text-center">
              <Link href="https://simulador.embracon.com.br/simulacao?interest=">
                <button
                  type="button"
