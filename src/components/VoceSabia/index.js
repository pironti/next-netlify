    ...
    <div className="relative p-8">
      <div className="relative max-w-7xl mx-auto md:p-0 p-3">
        ...
        <div className="relative bg-white max-w-7xl rounded-lg mx-auto p-6 mt-8">
          <h1 className="font-extrabold text-3xl md:text-3xl mb-8">
        ...
        <div className="relative bg-white max-w-7xl rounded-lg mx-auto p-6 mt-8">
          <h1 className="font-extrabold text-3xl md:text-3xl">
            Grupos: entenda como funcionam no consórcio
          </h1>
        </div>

        <div className="relative bg-white max-w-7xl rounded-lg mx-auto p-6 mt-8">
          <h1 className="font-extrabold text-3xl md:text-3xl">
            O papel do BACEN e da administradora de consórcio
          </h1>
        </div>
